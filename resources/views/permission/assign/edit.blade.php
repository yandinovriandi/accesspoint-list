                                    ...
                                    <div class="p-6">
                                        <form action="{{ route('assign.edit', $role) }}" method="post">
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <select id="permissions" multiple class="w-full select2-multiple mb-4"
                                            ...
                                            <div
                                                class="mt-4 flex items-center justify-center lg:justify-start p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                                <button
                                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                    Assign
                                                </button>
                                                <a href="{{ route('assign.table') }}"
