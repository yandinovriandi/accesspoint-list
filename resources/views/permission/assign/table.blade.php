            ...
            <div class="px-4">
                <header>
                    <div x-data="{open:false}" class="flex items-center justify-between py-4 px-2 w-full border-b-2">
                        ...
                        <x-form-modal state="open" x-show="open" title="Assign Permissions to user">
                            <form action="{{ route('assign.table') }}" method="post">
                                @csrf
                                <div>
                                ...
                                <div class="mt-4">
                                    <x-label class="mb-3" for="permissions" :value="__('Permissions Name')" />

                                    <select id="permissions" multiple class="select2-multiple mb-4" type="text"
                                        name="permissions[]">
