                                                ...
                                                <tr class=" border-b last:border-b-0 hover:bg-blue-50/30">
                                                    ...
                                                    <td class=" whitespace-nowrap px-5 py-4 text-sm">
                                                        <a class="font-light"
                                                            ...
                                                            <span
                                                                class="px-2 py-0.5 text-cyan-500 bg-cyan-100 rounded-lg hover:text-cyan-700">{{ $user->name }}</span>
                                                        </a>
                                                    </td>
                                                    <td class=" whitespace-nowrap px-5 py-4 text-sm">
                                                        {{ $user->email }}
                                                    ...
                                                    dark:focus:ring-red-800"
                                                                ...
                                                                <x-form-modal state="open" x-show="open"
                                                                    ...
                                                                    <form
                                                                        action="{{ route('permissions.delete', $user) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <p class="mb-6 text-center">
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                class="text-red-500 text-lg font-semibold">{{ $user->name }}</span>
